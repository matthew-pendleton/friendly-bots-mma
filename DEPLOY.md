# Deploying friendly-mma to a VPS
...
## 4. Clone your repo
```bash
git clone https://github.com/yourusername/friendly-mma.git ~/bots/friendly-mma
```
...
```bash
pm2 start index.js --name friendly-mma
```
...
| `pm2 logs friendly-mma` | View live logs |
| `pm2 restart friendly-mma` | Restart the bot |
| `pm2 stop friendly-mma` | Stop the bot |
| `pm2 delete friendly-mma` | Remove from pm2 |
