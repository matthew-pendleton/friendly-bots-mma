...
const AUDIENCE_FLAVOR = [
  ...
  "👥 *chat: they just stood there. why did they just stand there.*",
  "👥 *chat: the audacity*",
  "👥 *chat: uninstall*",
...
const FINISHERS = [
  ...
  (w, l) => `💀 **BRUTALITY** — *“What is this?! **${w}** just rolled a massive steel oxygen tank into the cage! They're trying to jam it into **${l}**’s mouth! NO! NO! Don’t tell me... **${w}** has a revolver! They shoot the tank! **KABOOM!** It is a slaughterhouse in there! **${l}** is scattered in pieces across the first three rows!”* 💥🦈`,
  (w, l) => `💀 **FINISHER** — *“Here comes **${w}**! **${w}** has the steel ch—wait. That’s not a chair. That's a... little black notebook? **${w}** just wrote... **${l}**'s name in it? ...Wait, **${l}** just dropped. Cardiac arrest! They're clutching their chest! **${l}** is fading! A *HEART ATTACK*?! THIS IS NOT THE WAY I WANTED THIS MAIN EVENT TO END!”* 📓`,
  (w, l) => `💀 **BRUTALITY** — *“Look at **${w}**! While **${l}** was recovering, **${w}** just... *piled up* blocks of T-N-T in the corner? They're running wires! They have a lever! ...*“FOR THE LOVE OF JERRY LAWLER, NO!”* 💥*💥*💥 **${l}** has been atomized into blocky particles! **${w}** is standing there mining the referee! What am I witnessing?!”*`,
  (w, l) => `💀 **FINISHER** — *“**${w}** is powering up! They're yelling **some weeby nonsense**!! Good Lord, the entire arena is illuminating! **${w}** unleashes a beam of pure energy! **${l}** isn't just knocked out, **${l}** has been turned into a fine, glowing dust! They're gone! There’s nothing left!”* 💥🌌`,
  (w, l) => `💀 **FINISHER** — *“**${w}** has found... a fire flower? In the middle of an MMA fight?! **${w}** eats it... and **${w}**'s mouth is glowing! No! No! Don’t you do it! They spit it! **A LIVING FIREBALL!** **${l}** has been engulfed! **${l}** is screaming! The referee is running away! **${l}** is a baked potato! This is insanity!”* 🔥🍄`,
  ...
  (w, l) => `💀 **BRUTALITY** — *“My God! **${w}** has snapped! **${w}** has grabbed a fire axe and is chopping down the cage door! For the love of Jerry Lawler, they're through! NO! **THE AXE!** They just split **${l}**’s head vertically down the middle! This isn't wrestling! This is a horror movie! Someone stop this! **WHERE ARE THE MODS?!**”* 🪓🚪`,
  ...
  (w, l) => `💀 **FINISHER** — *“My God! **${w}** has reached under the ring... that’s not a chair! That's an industrial staple gun! NO! Don’t you do it! They grabbed **${l}**’s nose! **CHUNQUE.** *Oh, the humanity!* They just stapled **${l}**’s nose directly to their own chest! **${l}** is screaming! **${w}** just got a three-count and is stapling a 'Property of **${w}**' sign to the canvas! It’s a tragedy!”* 🔫👃`,
  (w, l) => `💀 **FINISHER** — *“**${w}** just pulled out a vintage 1887 shotgun! **${w}** puts on a pair of sunglasses and says... 'Hasta la vista, **baby**.' They just put the barrel right in **${l}**'s face. *BLAM!* By god, there’s a metallic endoskeleton where **${l}** used to be! Was this entire fight staged?!”* 😎🔫`,
...
const CHALLENGE_TAUNTS = [
  ...
  (c, d) => `🪑 <@${c}> Hey <@${d}>, you look like someone who loses fights at Applebee's.`,
